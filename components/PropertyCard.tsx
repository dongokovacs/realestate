          ...
          >
            ...
            <div className="relative h-60 overflow-hidden">
              ...
              <div className="absolute top-4 left-4">
                <span className={`inline-block border text-[9px] uppercase tracking-[0.18em] font-black px-3 py-1 rounded-full ${tagStyles[property.tag]}`}>
                  {property.tag}
                </span>
              </div>
              <div
                ...
                style={{ boxShadow: "inset 0 0 0 1.5px rgba(59,114,232,0.5)" }}
              />
            </div>
            ...
            <div className="p-5">
              <h3
                className="text-off-white font-black text-lg mb-1 leading-tight"
