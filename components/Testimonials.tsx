...
const testimonials = [
  {
    quote:
      "Haven didn't just find us a house — they found us a life. Our Montecito estate exceeded every expectation, and the process was seamless from first showing to final signature.",
  ...
  {
    quote:
      "The team's understanding of ultra-prime real estate is unmatched. They negotiated a price 8% below asking on a property we thought was beyond our reach. Extraordinary professionals.",
  ...
  {
    quote:
      "After 14 years of searching across three continents, Haven found our family compound in Malibu in just six weeks. Their off-market network is remarkable.",
  ...
  return (
    <section className="relative bg-navy py-28 md:py-36 overflow-hidden">
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse 70% 60% at 30% 50%, rgba(26,58,107,0.25) 0%, transparent 70%)",
        }}
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="relative">
            ...
            >
              ...
              >
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <blockquote className="text-off-white/80 text-lg md:text-xl font-bold leading-relaxed mb-8">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div
                        ...
                        style={{
                          background: "linear-gradient(135deg, rgba(59,114,232,0.3), rgba(139,94,60,0.3))",
                      ...
                      <div>
                        <div className="text-off-white font-black text-sm">
                          {testimonials[active].name}
                        </div>
                        <div className="text-brown-light text-[11px] font-bold mt-0.5">
            ...
            <div
              ...
              style={{
                background: "radial-gradient(circle, rgba(59,114,232,0.2) 0%, transparent 70%)",
              }}
            />
          </div>
        </div>
