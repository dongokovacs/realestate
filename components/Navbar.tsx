      ...
      >
        ...
        >
          ...
          <Link href="/" className="flex items-center gap-2 group">
            <span
              className="text-2xl tracking-[0.2em] text-off-white font-black leading-none transition-colors duration-300 group-hover:text-brown-light"
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            >
              Book a Tour
              <span className="w-5 h-5 rounded-full bg-white/10 flex items-center justify-center transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5">
